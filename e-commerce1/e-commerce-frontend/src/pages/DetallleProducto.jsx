      ...
      <div style={containerStyle}>
        ...
        <div style={imgSection}>
          <img 
            ...
            alt={p.nombre} 
            style={imgFit} 
            onError={(e) => { e.target.src = 'https://via.placeholder.com/600?text=ESTUDIO+40' }}
          />
        </div>
        ...
        <div style={infoSection}>
          <span style={catLabelStyle}>
            {p.categoria?.nombreCategoria || 'Colección Exclusiva'}
          </span>
          ...
          <div style={authorSection}>
            ...
            <span style={authorName}>
              {p.usuario?.nombre || p.usuario?.username || 'Admin'}
            </span>
          </div>
