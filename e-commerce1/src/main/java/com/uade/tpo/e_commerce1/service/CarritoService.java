...
import com.uade.tpo.e_commerce1.dto.CarritoItemResponseDTO;
...
public class CarritoService {
    ...
    public String agregarAlCarrito(Long usuarioId, Long productoId, Integer cantidad) {
        ...
        CarritoItem itemExistente = carritoRepository
            .findByUsuarioIdAndProductoId(usuarioId, productoId)
            .orElse(null);
        int cantidadTotal = cantidad + (itemExistente != null ? itemExistente.getCantidad() : 0);
    ...
    public List<CarritoItemResponseDTO> obtenerCarrito(Long usuarioId) {
    ...
    private CarritoItemResponseDTO mapToResponseDTO(CarritoItem item) {
        Producto producto = item.getProducto();
        CarritoItemResponseDTO dto = new CarritoItemResponseDTO();

        dto.setCarritoItemId(item.getId());
        ...
        dto.setCantidadElegida(item.getCantidad());
