...
import { useCrearProductoMutation, useGetCategoriasQuery } from '../store/api/ecommerceApi';
...
function CrearProducto() {
  ...
  const [crearProducto, { isLoading }] = useCrearProductoMutation();
      ...
      <div style={containerStyle}>
        <form onSubmit={manejarEnvio} style={formStyle}>
          ...
          <button type="submit" style={btnPublishStyle} disabled={isLoading}>
            <span style={btnTextInner}>{isLoading ? 'Publicando...' : '+ Publicar Producto'}</span>
          </button>
        </form>
      </div>
    </div>
